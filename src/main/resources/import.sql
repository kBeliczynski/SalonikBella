...
INSERT INTO `SalonikBella`.`perfume` (`description`,`extra_info`,`gender`,`name`,`photo`,`price`,`smell`,`volume`) VALUES ('Eksplozja nut cytrusowych tworzy bardzo pociągający zapach. Delikatne akordy piżma napawają  pogodnym nastawieniem.','BRAK','mk','beach','img/perfumy/beach/beach15.jpg',25,'Aromatyczno - Drzewna, Beach to zrównoważony, czysty zapach. Idealny dla kobiet i mężczyzn.Nuty głowy : Pomarańcza, Nuty serca : Konwalia, Nuty bazy : Piżmo.',15);
INSERT INTO `SalonikBella`.`perfume` (`description`,`extra_info`,`gender`,`name`,`photo`,`price`,`smell`,`volume`) VALUES ('Fuzja nut hesperydowych z cyklamenem i nutami drzewnymi pozwoliła na stworzenie ekspresywnego zapachu pachnącego wolnością.','BRAK','m','acqua per uomo','https://www.yodeyma.com/img/p/2/1/9/8/2198-thickbox_default.jpg',25,'Aromatyczno - Wodna. Acqua per uomo to świeży zapach dla naturalnego i współczesnego mężczyzny. Nuty głowy : Bergamotka, nuty serca : Cyklamen, nuty bazy : Drzewo.',15);
